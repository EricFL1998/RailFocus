...
interface JourneyDataAccess {
    ...
    @Query("UPDATE journey_records SET actualDurationMin = :actualDurationMin, completedAt = :completedAt WHERE id = :id")
    suspend fun updateCompletion(id: String, actualDurationMin: Int, completedAt: Long)
